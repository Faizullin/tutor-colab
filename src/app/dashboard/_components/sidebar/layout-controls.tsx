...
import { ContentLayout, SidebarCollapsible, SidebarVariant } from "@/config/preferences/layout";
import { THEME_PRESET_OPTIONS, ThemeMode, ThemePreset } from "@/config/preferences/theme";
